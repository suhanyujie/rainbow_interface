...
const (
	...
	EffectType_Effect1KeepDecrHp EffectType = 1 // 位移
...
type ScSkillFog struct {
	...
	// 持续时间 | @inject_tag: msgpack:"keepSec" json:"keepSec"
	KeepSec int32 `protobuf:"varint,2,opt,name=keepSec,proto3" json:"keepSec" msgpack:"keepSec"`
	// 横向格子数 | @inject_tag: msgpack:"xNum" json:"xNum"
...
type ScSkillAttract struct {
	...
	YNum int32 `protobuf:"varint,4,opt,name=yNum,proto3" json:"yNum" msgpack:"yNum"`
	// 可吸取的石格类型列表 | @inject_tag: msgpack:"stTypes" json:"stTypes"
	// 石格类型：100原初之力+1；102 hp+；104 hp-；106 atk+；108 atk-
	StTypes []int32 `protobuf:"varint,5,rep,packed,name=stTypes,proto3" json:"stTypes" msgpack:"stTypes"`
}
...
func (x *ScSkillAttract) GetStTypes() []int32 {
	if x != nil {
		return x.StTypes
	}
	return nil
...
type Buff struct {
	...
	Priority int32 `protobuf:"varint,2,opt,name=priority,proto3" json:"priority" msgpack:"priority"`
	// buff 开始生效的时间戳 | @inject_tag: msgpack:"startTime" json:"startTime"
	StartTime int32 `protobuf:"varint,3,opt,name=startTime,proto3" json:"startTime" msgpack:"startTime"`
	// buff 生效结束的时间戳 | @inject_tag: msgpack:"endTime" json:"endTime"
	EndTime int32 `protobuf:"varint,4,opt,name=endTime,proto3" json:"endTime" msgpack:"endTime"`
	// 对应的技能效果类型 | @inject_tag: msgpack:"skillEffType" json:"skillEffType"
	SkillEffType int32 `protobuf:"varint,5,opt,name=skillEffType,proto3" json:"skillEffType" msgpack:"skillEffType"`
	// buff 作用的角色属性 | @inject_tag: msgpack:"effRoleAttr" json:"effRoleAttr"
	EffRoleAttr BuffRoleAttr `protobuf:"varint,6,opt,name=effRoleAttr,proto3,enum=rainbow.v1.BuffRoleAttr" json:"effRoleAttr" msgpack:"effRoleAttr"`
	// buff 的控制效果 | @inject_tag: msgpack:"controlEff" json:"controlEff"
	ControlEff ControlEff `protobuf:"varint,7,opt,name=controlEff,proto3,enum=rainbow.v1.ControlEff" json:"controlEff" msgpack:"controlEff"`
}
...
var file_rainbow_proto_rawDesc = []byte{
	...
	0x62, 0x6f, 0x77, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x6f, 0x6c, 0x65, 0x50, 0x6f, 0x73, 0x69, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x06, 0x6e, 0x65, 0x77, 0x50, 0x6f, 0x73, 0x22, 0x79, 0x0a, 0x11, 0x53,
	...
	0x66, 0x66, 0x54, 0x79, 0x70, 0x65, 0x22, 0x68, 0x0a, 0x0a, 0x53, 0x63, 0x53, 0x6b, 0x69, 0x6c,
	...
	0x22, 0x72, 0x0a, 0x0e, 0x53, 0x63, 0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x41, 0x74, 0x74, 0x72, 0x61,
	0x63, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x66, 0x72, 0x6f, 0x6d, 0x55, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0x65, 0x65, 0x70, 0x53, 0x65, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x79, 0x4e, 0x75, 0x6d, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x79, 0x4e, 0x75, 0x6d, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x74,
	0x54, 0x79, 0x70, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x05, 0x52, 0x07, 0x73, 0x74, 0x54,
	0x79, 0x70, 0x65, 0x73, 0x22, 0x6b, 0x0a, 0x0d, 0x53, 0x63, 0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x53,
	...
	0x01, 0x28, 0x02, 0x52, 0x05, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x22, 0xa5, 0x02, 0x0a, 0x04, 0x42,
	...
	0x66, 0x66, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69,
	...
	0x05, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x22, 0x0a, 0x0c, 0x73, 0x6b,
	0x69, 0x6c, 0x6c, 0x45, 0x66, 0x66, 0x54, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x0c, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x45, 0x66, 0x66, 0x54, 0x79, 0x70, 0x65, 0x12, 0x3a,
	0x0a, 0x0b, 0x65, 0x66, 0x66, 0x52, 0x6f, 0x6c, 0x65, 0x41, 0x74, 0x74, 0x72, 0x18, 0x06, 0x20,
	...
	0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x45, 0x66, 0x66, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16,
	...
	0x66, 0x66, 0x22, 0x53, 0x0a, 0x15, 0x53, 0x63, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x47, 0x61,
	...
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2a, 0x2b, 0x0a, 0x08, 0x47, 0x61, 0x6d, 0x65,
	...
	0x10, 0x03, 0x2a, 0x5b, 0x0a, 0x0a, 0x45, 0x66, 0x66, 0x65, 0x63, 0x74, 0x54, 0x79, 0x70, 0x65,
	...
	0x66, 0x65, 0x63, 0x74, 0x32, 0x52, 0x69, 0x67, 0x69, 0x64, 0x69, 0x74, 0x79, 0x10, 0x02, 0x12,
	0x0e, 0x0a, 0x0a, 0x45, 0x66, 0x66, 0x65, 0x63, 0x74, 0x33, 0x46, 0x6f, 0x67, 0x10, 0x03, 0x2a,
	0x3b, 0x0a, 0x0b, 0x42, 0x75, 0x66, 0x66, 0x45, 0x66, 0x66, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x14,
	...
	,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x72, 0x61, 0x69, 0x6e, 0x62, 0x6f, 0x77, 0x2f, 0x76, 0x31,
...
var file_rainbow_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
var file_rainbow_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_rainbow_proto_goTypes = []interface{}{
	...
	(BuffEffMode)(0),              // 6: rainbow.v1.BuffEffMode
	(BuffRoleAttr)(0),             // 7: rainbow.v1.BuffRoleAttr
	(ControlEff)(0),               // 8: rainbow.v1.ControlEff
	(*Message)(nil),               // 9: rainbow.v1.Message
	(*ErrInfo)(nil),               // 10: rainbow.v1.ErrInfo
	(*NormalInfo)(nil),            // 11: rainbow.v1.NormalInfo
	(*UserLogin)(nil),             // 12: rainbow.v1.UserLogin
	(*JoinGameReq)(nil),           // 13: rainbow.v1.JoinGameReq
	(*ScPlayerJoin)(nil),          // 14: rainbow.v1.ScPlayerJoin
	(*RoomDetail)(nil),            // 15: rainbow.v1.RoomDetail
	(*Player)(nil),                // 16: rainbow.v1.Player
	(*RoleInfo)(nil),              // 17: rainbow.v1.RoleInfo
	(*RoleState)(nil),             // 18: rainbow.v1.RoleState
	(*RolePosition)(nil),          // 19: rainbow.v1.RolePosition
	(*RoleSkill)(nil),             // 20: rainbow.v1.RoleSkill
	(*CsGetNewRoadV1)(nil),        // 21: rainbow.v1.CsGetNewRoadV1
	(*BrPlayerDie)(nil),           // 22: rainbow.v1.BrPlayerDie
	(*BrGameEndOf1V1)(nil),        // 23: rainbow.v1.BrGameEndOf1V1
	(*PlayerSettleInfo)(nil),      // 24: rainbow.v1.PlayerSettleInfo
	(*ScGetNewRoad)(nil),          // 25: rainbow.v1.ScGetNewRoad
	(*ScGetNewRoadV1)(nil),        // 26: rainbow.v1.ScGetNewRoadV1
	(*OnePassageRoad)(nil),        // 27: rainbow.v1.OnePassageRoad
	(*OneCell)(nil),               // 28: rainbow.v1.OneCell
	(*ScBossFightRes)(nil),        // 29: rainbow.v1.ScBossFightRes
	(*ScPickItemReq)(nil),         // 30: rainbow.v1.ScPickItemReq
	(*CsJudgeOpt)(nil),            // 31: rainbow.v1.CsJudgeOpt
	(*BrPickItem)(nil),            // 32: rainbow.v1.BrPickItem
	(*BrPlayerRollback)(nil),      // 33: rainbow.v1.BrPlayerRollback
	(*BrRolePositions)(nil),       // 34: rainbow.v1.BrRolePositions
	(*ScGetRolePos)(nil),          // 35: rainbow.v1.ScGetRolePos
	(*BrRoleReachPivot)(nil),      // 36: rainbow.v1.BrRoleReachPivot
	(*BrGameStart)(nil),           // 37: rainbow.v1.BrGameStart
	(*CsUseSkill)(nil),            // 38: rainbow.v1.CsUseSkill
	(*ScSkillDisplacement)(nil),   // 39: rainbow.v1.ScSkillDisplacement
	(*ScSkillEffectInfo)(nil),     // 40: rainbow.v1.ScSkillEffectInfo
	(*ScSkillFog)(nil),            // 41: rainbow.v1.ScSkillFog
	(*ScSkillAttract)(nil),        // 42: rainbow.v1.ScSkillAttract
	(*ScSkillShadow)(nil),         // 43: rainbow.v1.ScSkillShadow
	(*ScSkillDeBuffHp)(nil),       // 44: rainbow.v1.ScSkillDeBuffHp
	(*ScSkillDeBuffAtk)(nil),      // 45: rainbow.v1.ScSkillDeBuffAtk
	(*ScSkillBuffAtk)(nil),        // 46: rainbow.v1.ScSkillBuffAtk
	(*ScSkillFloat)(nil),          // 47: rainbow.v1.ScSkillFloat
	(*ScSkillSprint)(nil),         // 48: rainbow.v1.ScSkillSprint
	(*ScSkillResistHurt)(nil),     // 49: rainbow.v1.ScSkillResistHurt
	(*Buff)(nil),                  // 50: rainbow.v1.Buff
	(*ScPlayerGameEndFor1VN)(nil), // 51: rainbow.v1.ScPlayerGameEndFor1vN
	(*ScGetServerTime)(nil),       // 52: rainbow.v1.ScGetServerTime
	nil,                           // 53: rainbow.v1.ScBossFightRes.CratesEntry
}
var file_rainbow_proto_depIdxs = []int32{
	0,  // 0: rainbow.v1.JoinGameReq.roomType:type_name -> rainbow.v1.GameType
	15, // 1: rainbow.v1.ScPlayerJoin.room:type_name -> rainbow.v1.RoomDetail
	16, // 2: rainbow.v1.RoomDetail.players:type_name -> rainbow.v1.Player
	17, // 3: rainbow.v1.Player.roleInfo:type_name -> rainbow.v1.RoleInfo
	18, // 4: rainbow.v1.Player.roleState:type_name -> rainbow.v1.RoleState
	19, // 5: rainbow.v1.RoleState.pos:type_name -> rainbow.v1.RolePosition
	20, // 6: rainbow.v1.RoleState.skill:type_name -> rainbow.v1.RoleSkill
	1,  // 7: rainbow.v1.RoleSkill.state:type_name -> rainbow.v1.SkillState
	19, // 8: rainbow.v1.BrPlayerDie.diePos:type_name -> rainbow.v1.RolePosition
	16, // 9: rainbow.v1.BrGameEndOf1V1.winPlayer:type_name -> rainbow.v1.Player
	16, // 10: rainbow.v1.BrGameEndOf1V1.losePlayer:type_name -> rainbow.v1.Player
	24, // 11: rainbow.v1.BrGameEndOf1V1.playerSettles:type_name -> rainbow.v1.PlayerSettleInfo
	2,  // 12: rainbow.v1.BrGameEndOf1V1.gameOverType:type_name -> rainbow.v1.GameOverType
	16, // 13: rainbow.v1.BrGameEndOf1V1.rankedPlayers:type_name -> rainbow.v1.Player
	27, // 14: rainbow.v1.ScGetNewRoad.data:type_name -> rainbow.v1.OnePassageRoad
	27, // 15: rainbow.v1.ScGetNewRoadV1.data:type_name -> rainbow.v1.OnePassageRoad
	28, // 16: rainbow.v1.OnePassageRoad.cells:type_name -> rainbow.v1.OneCell
	53, // 17: rainbow.v1.ScBossFightRes.crates:type_name -> rainbow.v1.ScBossFightRes.CratesEntry
	...
	19, // 20: rainbow.v1.BrPlayerRollback.newPos:type_name -> rainbow.v1.RolePosition
	15, // 21: rainbow.v1.BrRolePositions.roomDetail:type_name -> rainbow.v1.RoomDetail
	19, // 22: rainbow.v1.ScGetRolePos.pos:type_name -> rainbow.v1.RolePosition
	15, // 23: rainbow.v1.BrGameStart.roomDetail:type_name -> rainbow.v1.RoomDetail
	19, // 24: rainbow.v1.ScSkillDisplacement.newPos:type_name -> rainbow.v1.RolePosition
	5,  // 25: rainbow.v1.ScSkillEffectInfo.effType:type_name -> rainbow.v1.EffectType
	6,  // 26: rainbow.v1.Buff.effMode:type_name -> rainbow.v1.BuffEffMode
	7,  // 27: rainbow.v1.Buff.effRoleAttr:type_name -> rainbow.v1.BuffRoleAttr
	8,  // 28: rainbow.v1.Buff.controlEff:type_name -> rainbow.v1.ControlEff
	16, // 29: rainbow.v1.ScPlayerGameEndFor1vN.ranks:type_name -> rainbow.v1.Player
