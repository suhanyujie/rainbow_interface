...
type Buff struct {
	...
	EffUidList []string `protobuf:"bytes,13,rep,name=effUidList,proto3" json:"effUidList" msgpack:"effUidList"`
}
...
func (x *Buff) GetEffUidList() []string {
	if x != nil {
		return x.EffUidList
	}
	return nil
...
var file_rainbow_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x65, 0x66, 0x66, 0x55, 0x69, 0x64, 0x4c,
	...
	0x10, 0x06, 0x2a, 0x3b, 0x0a, 0x0b, 0x42, 0x75, 0x66, 0x66, 0x45, 0x66, 0x66, 0x4d, 0x6f, 0x64,
	...
	0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x54, 0x69, 0x6d, 0x65, 0x53, 0x65, 0x63, 0x10, 0x02, 0x2a,
