...
type PlayerDieReason int32

const (
	PlayerDieReason_DieReason_Empty PlayerDieReason = 0
	// 掉落
	PlayerDieReason_Fall PlayerDieReason = 1
	// 陷进
	PlayerDieReason_Snare PlayerDieReason = 2
	// 生命值为 0
	PlayerDieReason_HpZero PlayerDieReason = 3
	// 枢纽对战输了
	PlayerDieReason_PivotDefeat PlayerDieReason = 4
)

// Enum value maps for PlayerDieReason.
var (
	PlayerDieReason_name = map[int32]string{
		0: "DieReason_Empty",
		1: "Fall",
		2: "Snare",
		3: "HpZero",
	...
	PlayerDieReason_value = map[string]int32{
		"DieReason_Empty": 0,
		"Fall":            1,
		"Snare":           2,
		"HpZero":          3,
...
func (x PlayerDieReason) Enum() *PlayerDieReason {
	p := new(PlayerDieReason)
	*p = x
	return p
}

func (x PlayerDieReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PlayerDieReason) Descriptor() protoreflect.EnumDescriptor {
	return file_rainbow_proto_enumTypes[2].Descriptor()
}

func (PlayerDieReason) Type() protoreflect.EnumType {
	return &file_rainbow_proto_enumTypes[2]
}

func (x PlayerDieReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PlayerDieReason.Descriptor instead.
func (PlayerDieReason) EnumDescriptor() ([]byte, []int) {
...
func (ControlEff) Descriptor() protoreflect.EnumDescriptor {
	return file_rainbow_proto_enumTypes[10].Descriptor()
}

func (ControlEff) Type() protoreflect.EnumType {
	return &file_rainbow_proto_enumTypes[10]
}
...
type JoinGameReq struct {
	...
	NftId int32 `protobuf:"varint,12,opt,name=nftId,proto3" json:"nftId" msgpack:"nftId"`
	// 和 roomType 参数一样，只不过是一个新的参数名 | @inject_tag: msgpack:"gameMode" json:"gameMode"
	GameMode GameType `protobuf:"varint,13,opt,name=gameMode,proto3,enum=rainbow.v1.GameType" json:"gameMode" msgpack:"gameMode"`
}
...
func (x *JoinGameReq) GetNftId() int32 {
	if x != nil {
		return x.NftId
	}
	return 0
...
func (x *JoinGameReq) GetGameMode() GameType {
	if x != nil {
		return x.GameMode
	}
	return GameType_Pve
...
type ScPlayerJoin struct {
	...
	GameMode GameType `protobuf:"varint,7,opt,name=gameMode,proto3,enum=rainbow.v1.GameType" json:"gameMode" msgpack:"gameMode"`
}
...
func (x *ScPlayerJoin) GetGameMode() GameType {
	if x != nil {
		return x.GameMode
	}
	return GameType_Pve
...
type BrPlayerDie struct {
	...
	DiePos *OneStone `protobuf:"bytes,3,opt,name=diePos,proto3" json:"diePos" msgpack:"diePos"`
	// 死亡原因 | @inject_tag: msgpack:"dieReason" json:"dieReason"
	DieReason PlayerDieReason `protobuf:"varint,4,opt,name=dieReason,proto3,enum=rainbow.v1.PlayerDieReason" json:"dieReason" msgpack:"dieReason"`
}
...
func (x *BrPlayerDie) GetDiePos() *OneStone {
	if x != nil {
		return x.DiePos
	}
	return nil
...
func (x *BrPlayerDie) GetDieReason() PlayerDieReason {
	if x != nil {
		return x.DieReason
	}
	return PlayerDieReason_DieReason_Empty
}
...
type ScPvePlayerDieQueryRevive struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// 游戏结束原因信息 | @inject_tag: msgpack:"gameOverInfo" json:"gameOverInfo"
	GameOverType GameOverType `protobuf:"varint,5,opt,name=gameOverType,proto3,enum=rainbow.v1.GameOverType" json:"gameOverInfo" msgpack:"gameOverInfo"`
}

func (x *ScPvePlayerDieQueryRevive) Reset() {
	*x = ScPvePlayerDieQueryRevive{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rainbow_proto_msgTypes[53]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ScPvePlayerDieQueryRevive) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ScPvePlayerDieQueryRevive) ProtoMessage() {}

func (x *ScPvePlayerDieQueryRevive) ProtoReflect() protoreflect.Message {
	mi := &file_rainbow_proto_msgTypes[53]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ScPvePlayerDieQueryRevive.ProtoReflect.Descriptor instead.
func (*ScPvePlayerDieQueryRevive) Descriptor() ([]byte, []int) {
	return file_rainbow_proto_rawDescGZIP(), []int{53}
}

func (x *ScPvePlayerDieQueryRevive) GetPlayer() *Player {
	if x != nil {
		return x.Player
	}
	return nil
...
func (x *ScPvePlayerDieQueryRevive) GetDesc() string {
	if x != nil {
		return x.Desc
	}
	return ""
...
func (x *ScPvePlayerDieQueryRevive) GetPlayerSettle() *PlayerSettleInfo {
	if x != nil {
...
func (x *ScPvePlayerDieQueryRevive) GetUsedTimeSec() int32 {
	if x != nil {
		return x.UsedTimeSec
	}
	return 0
...
func (x *ScPvePlayerDieQueryRevive) GetGameOverType() GameOverType {
	if x != nil {
		return x.GameOverType
	}
	return GameOverType_GOT_Empty
...
// 使用道具请求，如：复活
type CsUsingPropReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// 是否使用道具 | @inject_tag: msgpack:"isUsingProp" json:"isUsingProp"
	IsUsingProp bool `protobuf:"varint,1,opt,name=isUsingProp,proto3" json:"isUsingProp" msgpack:"isUsingProp"`
	// 使用道具的 id | @inject_tag: msgpack:"propId" json:"propId"
	PropId int32 `protobuf:"varint,2,opt,name=propId,proto3" json:"propId" msgpack:"propId"`
	// 道具的数量 | @inject_tag: msgpack:"num" json:"num"
	Num int32 `protobuf:"varint,3,opt,name=num,proto3" json:"num" msgpack:"num"`
}

func (x *CsUsingPropReq) Reset() {
	*x = CsUsingPropReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rainbow_proto_msgTypes[54]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *CsUsingPropReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CsUsingPropReq) ProtoMessage() {}

func (x *CsUsingPropReq) ProtoReflect() protoreflect.Message {
	mi := &file_rainbow_proto_msgTypes[54]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CsUsingPropReq.ProtoReflect.Descriptor instead.
func (*CsUsingPropReq) Descriptor() ([]byte, []int) {
	return file_rainbow_proto_rawDescGZIP(), []int{54}
}

func (x *CsUsingPropReq) GetIsUsingProp() bool {
	if x != nil {
		return x.IsUsingProp
	}
	return false
}

func (x *CsUsingPropReq) GetPropId() int32 {
	if x != nil {
		return x.PropId
	}
	return 0
...
func (x *CsUsingPropReq) GetNum() int32 {
	if x != nil {
		return x.Num
	}
	return 0
...
type ScUsingPropReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// 使用是否成功 | @inject_tag: msgpack:"isOk" json:"isOk"
	IsOk bool `protobuf:"varint,1,opt,name=isOk,proto3" json:"isOk" msgpack:"isOk"`
	// 备注 | @inject_tag: msgpack:"msg" json:"msg"
	Msg string `protobuf:"bytes,2,opt,name=msg,proto3" json:"msg" msgpack:"msg"`
}

func (x *ScUsingPropReq) Reset() {
	*x = ScUsingPropReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rainbow_proto_msgTypes[55]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ScUsingPropReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ScUsingPropReq) ProtoMessage() {}

func (x *ScUsingPropReq) ProtoReflect() protoreflect.Message {
	mi := &file_rainbow_proto_msgTypes[55]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ScUsingPropReq.ProtoReflect.Descriptor instead.
func (*ScUsingPropReq) Descriptor() ([]byte, []int) {
	return file_rainbow_proto_rawDescGZIP(), []int{55}
}

func (x *ScUsingPropReq) GetIsOk() bool {
	if x != nil {
		return x.IsOk
	}
	return false
...
func (x *ScUsingPropReq) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_rainbow_proto_rawDesc = []byte{
	...
	,
	...
	0x07, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x49, 0x64, 0x12, 0x2a, 0x0a, 0x04, 0x72, 0x6f, 0x6f, 0x6d,
	...
	,
	...
	,
	...
	0x79, 0x22, 0x67, 0x0a, 0x09, 0x52, 0x6f, 0x6c, 0x65, 0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x12, 0x0e,
	...
	0x72, 0x61, 0x69, 0x6e, 0x62, 0x6f, 0x77, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x6b, 0x69, 0x6c, 0x6c,
	0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x1c, 0x0a, 0x09,
	0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x55, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x09, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x55, 0x69, 0x64, 0x22, 0x22, 0x0a, 0x0e, 0x43, 0x73,
	0x47, 0x65, 0x74, 0x4e, 0x65, 0x77, 0x52, 0x6f, 0x61, 0x64, 0x56, 0x31, 0x12, 0x10, 0x0a, 0x03,
	0x69, 0x64, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x69, 0x64, 0x78, 0x22, 0xa0,
	0x01, 0x0a, 0x0b, 0x42, 0x72, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x44, 0x69, 0x65, 0x12, 0x10,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x77, 0x50, 0x6f, 0x73, 0x22, 0xb5, 0x01, 0x0a, 0x11, 0x53, 0x63, 0x53, 0x6b, 0x69, 0x6c,
	0x6c, 0x45, 0x66, 0x66, 0x65, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x18, 0x0a, 0x07, 0x66,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
}
...
var file_rainbow_proto_enumTypes = make([]protoimpl.EnumInfo, 11)
var file_rainbow_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_rainbow_proto_goTypes = []interface{}{
	(GameType)(0),                     // 0: rainbow.v1.GameType
	(SkillState)(0),                   // 1: rainbow.v1.SkillState
	(PlayerDieReason)(0),              // 2: rainbow.v1.PlayerDieReason
	(GameOverType)(0),                 // 3: rainbow.v1.GameOverType
	(OperateType)(0),                  // 4: rainbow.v1.OperateType
	(AwardType)(0),                    // 5: rainbow.v1.AwardType
	(EffectType)(0),                   // 6: rainbow.v1.EffectType
	(EffTiming)(0),                    // 7: rainbow.v1.EffTiming
	(BuffEffMode)(0),                  // 8: rainbow.v1.BuffEffMode
	(BuffRoleAttr)(0),                 // 9: rainbow.v1.BuffRoleAttr
	(ControlEff)(0),                   // 10: rainbow.v1.ControlEff
	(*Message)(nil),                   // 11: rainbow.v1.Message
	(*ErrInfo)(nil),                   // 12: rainbow.v1.ErrInfo
	(*NormalInfo)(nil),                // 13: rainbow.v1.NormalInfo
	(*UserLogin)(nil),                 // 14: rainbow.v1.UserLogin
	(*JoinGameReq)(nil),               // 15: rainbow.v1.JoinGameReq
	(*ScPlayerJoin)(nil),              // 16: rainbow.v1.ScPlayerJoin
	(*RoomDetail)(nil),                // 17: rainbow.v1.RoomDetail
	(*Player)(nil),                    // 18: rainbow.v1.Player
	(*RoleInfo)(nil),                  // 19: rainbow.v1.RoleInfo
	(*RoleState)(nil),                 // 20: rainbow.v1.RoleState
	(*RolePosition)(nil),              // 21: rainbow.v1.RolePosition
	(*RoleSkill)(nil),                 // 22: rainbow.v1.RoleSkill
	(*CsGetNewRoadV1)(nil),            // 23: rainbow.v1.CsGetNewRoadV1
	(*BrPlayerDie)(nil),               // 24: rainbow.v1.BrPlayerDie
	(*BrGameEndOf1V1)(nil),            // 25: rainbow.v1.BrGameEndOf1V1
	(*PlayerSettleInfo)(nil),          // 26: rainbow.v1.PlayerSettleInfo
	(*ScGetNewRoad)(nil),              // 27: rainbow.v1.ScGetNewRoad
	(*ScGetNewRoadV1)(nil),            // 28: rainbow.v1.ScGetNewRoadV1
	(*OnePassageRoad)(nil),            // 29: rainbow.v1.OnePassageRoad
	(*OneCell)(nil),                   // 30: rainbow.v1.OneCell
	(*ScBossFightRes)(nil),            // 31: rainbow.v1.ScBossFightRes
	(*ScPickItemReq)(nil),             // 32: rainbow.v1.ScPickItemReq
	(*CsJudgeOpt)(nil),                // 33: rainbow.v1.CsJudgeOpt
	(*BrPickItem)(nil),                // 34: rainbow.v1.BrPickItem
	(*BrPlayerRollback)(nil),          // 35: rainbow.v1.BrPlayerRollback
	(*BrRolePositions)(nil),           // 36: rainbow.v1.BrRolePositions
	(*ScGetRolePos)(nil),              // 37: rainbow.v1.ScGetRolePos
	(*BrRoleReachPivot)(nil),          // 38: rainbow.v1.BrRoleReachPivot
	(*BrRolePivotFightEnd)(nil),       // 39: rainbow.v1.BrRolePivotFightEnd
	(*BrGameStart)(nil),               // 40: rainbow.v1.BrGameStart
	(*CsUseSkill)(nil),                // 41: rainbow.v1.CsUseSkill
	(*ScSkillDisplacement)(nil),       // 42: rainbow.v1.ScSkillDisplacement
	(*ScSkillEffectInfo)(nil),         // 43: rainbow.v1.ScSkillEffectInfo
	(*ScSkillFog)(nil),                // 44: rainbow.v1.ScSkillFog
	(*ScSkillAttract)(nil),            // 45: rainbow.v1.ScSkillAttract
	(*OneStone)(nil),                  // 46: rainbow.v1.OneStone
	(*BrRoleSkillRelease)(nil),        // 47: rainbow.v1.BrRoleSkillRelease
	(*BrRoleSkillReleaseEnd)(nil),     // 48: rainbow.v1.BrRoleSkillReleaseEnd
	(*BrRoleSkillEndForShadow)(nil),   // 49: rainbow.v1.BrRoleSkillEndForShadow
	(*ScSkillShadow)(nil),             // 50: rainbow.v1.ScSkillShadow
	(*ScSkillDeBuffHp)(nil),           // 51: rainbow.v1.ScSkillDeBuffHp
	(*ScSkillDeBuffAtk)(nil),          // 52: rainbow.v1.ScSkillDeBuffAtk
	(*ScSkillBuffAtk)(nil),            // 53: rainbow.v1.ScSkillBuffAtk
	(*ScSkillFloat)(nil),              // 54: rainbow.v1.ScSkillFloat
	(*ScSkillSprint)(nil),             // 55: rainbow.v1.ScSkillSprint
	(*ScSkillResistHurt)(nil),         // 56: rainbow.v1.ScSkillResistHurt
	(*ScSkillResistHurtEnd)(nil),      // 57: rainbow.v1.ScSkillResistHurtEnd
	(*Buff)(nil),                      // 58: rainbow.v1.Buff
	(*ScPlayerGameEndFor1VN)(nil),     // 59: rainbow.v1.ScPlayerGameEndFor1vN
	(*ScGetServerTime)(nil),           // 60: rainbow.v1.ScGetServerTime
	(*ScBeAtkBySkill)(nil),            // 61: rainbow.v1.ScBeAtkBySkill
	(*ScReleaseSkillBeforeInfo)(nil),  // 62: rainbow.v1.ScReleaseSkillBeforeInfo
	(*BrRoleAttrUpdate)(nil),          // 63: rainbow.v1.BrRoleAttrUpdate
	(*ScPvePlayerDieQueryRevive)(nil), // 64: rainbow.v1.ScPvePlayerDieQueryRevive
	(*CsUsingPropReq)(nil),            // 65: rainbow.v1.CsUsingPropReq
	(*ScUsingPropReq)(nil),            // 66: rainbow.v1.ScUsingPropReq
	nil,                               // 67: rainbow.v1.ScBossFightRes.CratesEntry
}
var file_rainbow_proto_depIdxs = []int32{
	0,  // 0: rainbow.v1.JoinGameReq.roomType:type_name -> rainbow.v1.GameType
	0,  // 1: rainbow.v1.JoinGameReq.gameMode:type_name -> rainbow.v1.GameType
	17, // 2: rainbow.v1.ScPlayerJoin.room:type_name -> rainbow.v1.RoomDetail
	0,  // 3: rainbow.v1.ScPlayerJoin.gameMode:type_name -> rainbow.v1.GameType
	18, // 4: rainbow.v1.RoomDetail.players:type_name -> rainbow.v1.Player
	19, // 5: rainbow.v1.Player.roleInfo:type_name -> rainbow.v1.RoleInfo
	20, // 6: rainbow.v1.Player.roleState:type_name -> rainbow.v1.RoleState
	21, // 7: rainbow.v1.RoleState.pos:type_name -> rainbow.v1.RolePosition
	22, // 8: rainbow.v1.RoleState.skill:type_name -> rainbow.v1.RoleSkill
	1,  // 9: rainbow.v1.RoleSkill.state:type_name -> rainbow.v1.SkillState
	46, // 10: rainbow.v1.BrPlayerDie.diePos:type_name -> rainbow.v1.OneStone
	2,  // 11: rainbow.v1.BrPlayerDie.dieReason:type_name -> rainbow.v1.PlayerDieReason
	18, // 12: rainbow.v1.BrGameEndOf1V1.winPlayer:type_name -> rainbow.v1.Player
	18, // 13: rainbow.v1.BrGameEndOf1V1.losePlayer:type_name -> rainbow.v1.Player
	26, // 14: rainbow.v1.BrGameEndOf1V1.playerSettles:type_name -> rainbow.v1.PlayerSettleInfo
	3,  // 15: rainbow.v1.BrGameEndOf1V1.gameOverType:type_name -> rainbow.v1.GameOverType
	18, // 16: rainbow.v1.BrGameEndOf1V1.rankedPlayers:type_name -> rainbow.v1.Player
	29, // 17: rainbow.v1.ScGetNewRoad.data:type_name -> rainbow.v1.OnePassageRoad
	29, // 18: rainbow.v1.ScGetNewRoadV1.data:type_name -> rainbow.v1.OnePassageRoad
	30, // 19: rainbow.v1.OnePassageRoad.cells:type_name -> rainbow.v1.OneCell
	67, // 20: rainbow.v1.ScBossFightRes.crates:type_name -> rainbow.v1.ScBossFightRes.CratesEntry
	4,  // 21: rainbow.v1.CsJudgeOpt.opType:type_name -> rainbow.v1.OperateType
	5,  // 22: rainbow.v1.BrPickItem.awardType:type_name -> rainbow.v1.AwardType
	21, // 23: rainbow.v1.BrPlayerRollback.newPos:type_name -> rainbow.v1.RolePosition
	17, // 24: rainbow.v1.BrRolePositions.roomDetail:type_name -> rainbow.v1.RoomDetail
	21, // 25: rainbow.v1.ScGetRolePos.pos:type_name -> rainbow.v1.RolePosition
	17, // 26: rainbow.v1.BrGameStart.roomDetail:type_name -> rainbow.v1.RoomDetail
	21, // 27: rainbow.v1.ScSkillDisplacement.newPos:type_name -> rainbow.v1.RolePosition
	6,  // 28: rainbow.v1.ScSkillEffectInfo.effType:type_name -> rainbow.v1.EffectType
	46, // 29: rainbow.v1.ScSkillAttract.stones:type_name -> rainbow.v1.OneStone
	6,  // 30: rainbow.v1.BrRoleSkillRelease.effType:type_name -> rainbow.v1.EffectType
	46, // 31: rainbow.v1.BrRoleSkillRelease.stones:type_name -> rainbow.v1.OneStone
	6,  // 32: rainbow.v1.BrRoleSkillReleaseEnd.effType:type_name -> rainbow.v1.EffectType
	18, // 33: rainbow.v1.BrRoleSkillEndForShadow.player:type_name -> rainbow.v1.Player
	8,  // 34: rainbow.v1.Buff.effMode:type_name -> rainbow.v1.BuffEffMode
	9,  // 35: rainbow.v1.Buff.effRoleAttr:type_name -> rainbow.v1.BuffRoleAttr
	10, // 36: rainbow.v1.Buff.controlEff:type_name -> rainbow.v1.ControlEff
	7,  // 37: rainbow.v1.Buff.effTiming:type_name -> rainbow.v1.EffTiming
	18, // 38: rainbow.v1.ScPlayerGameEndFor1vN.ranks:type_name -> rainbow.v1.Player
	9,  // 39: rainbow.v1.BrRoleAttrUpdate.attrType:type_name -> rainbow.v1.BuffRoleAttr
	18, // 40: rainbow.v1.ScPvePlayerDieQueryRevive.player:type_name -> rainbow.v1.Player
	26, // 41: rainbow.v1.ScPvePlayerDieQueryRevive.playerSettle:type_name -> rainbow.v1.PlayerSettleInfo
	3,  // 42: rainbow.v1.ScPvePlayerDieQueryRevive.gameOverType:type_name -> rainbow.v1.GameOverType
...
func file_rainbow_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rainbow_proto_msgTypes[53].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ScPvePlayerDieQueryRevive); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rainbow_proto_msgTypes[54].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CsUsingPropReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rainbow_proto_msgTypes[55].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ScUsingPropReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
